...
\\{\bf 3. Analiza metod¹ przekroczeñ progu (POT).} Kwantyl 90\% $u=3.29$ co oznacza, ¿e 10\% mierzonych fal przekracza³o wysokoœæ 3.29 m.  Ustalono próg na tym poziomie i wyestymowano parametry rozk³adu GPD dla nadwy¿ek nad ten próg:
...
\begin{itemize}
	\item Wykres nadwy¿ek nad próg 90\%:
\end{itemize}
...
\\{\bf 4. Podsumowanie.} Analizuj¹c powy¿sze wykresy oraz obliczenia mo¿na zauwa¿yæ, ¿e analiza metod¹ przekroczeñ progów  osi¹ga wiêkszy poziom zwrotu ni¿ druga metoda (tabela  poni¿ej). St¹d wniosek, ¿e w tym przypadku metoda przekroczeñ progu (POT) osi¹ga wiêksz¹ dok³adnoœæ ni¿ metoda maksimów blokowych (MMB).

$$\begin {array} {|c|c|c|}
\hline
\ & \mbox{Metoda maksimów blokowych} & \mbox{Metoda przekroczeñ progu}  \\
\hline              
\mbox{Poziom zwrotu $x_{20}$}&  6.602865 [m] & 6.689767 [m] \\
\hline
